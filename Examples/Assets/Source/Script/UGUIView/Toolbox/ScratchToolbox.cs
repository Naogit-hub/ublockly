...
namespace UBlockly.UGUI
{
    public class ScratchToolbox : BaseToolbox
    {
        ...
        public override bool CheckBin(BlockView blockView)
        {
            ...
            if (RectTransformUtility.RectangleContainsScreenPoint(toggleTrans, BlocklyUI.UICanvas.worldCamera.WorldToScreenPoint(blockView.transform.position), BlocklyUI.UICanvas.worldCamera))
            {
